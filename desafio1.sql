...
CREATE TABLE SpotifyClone.Seguindo(
    ...
    FOREIGN KEY (usuarios_seguindo) REFERENCES Usuarios (usuarios_id),
...
INSERT INTO SpotifyClone.Usuarios (usuarios_id, usuario, idade, tipos_plano, data_assinatura)
VALUES
...
INSERT INTO SpotifyClone.Albuns (albuns_id, artista, album, ano_lancamento)
VALUES
  (1, 6, 'Envious', 1990),
  (2,	6,	'Exuberant',	1993),
  (3,	4,	'Hallowed Steam',	1995),
  (4,	3,	'Incandescent',	1998),
  (5,	2,	'Temporary Culture',	2001),
  (6,	2,	'Library of liberty',	2003),
...
INSERT INTO SpotifyClone.Reproducoes (reproducoes_id, usuario, musica, data_reproducao)
VALUES
...
INSERT INTO SpotifyClone.Seguindo (usuarios_seguindo, artistas_seguidos)
VALUES
  (1, 1, 5),
  (2, 1, 9),
  (3, 1, 10),
